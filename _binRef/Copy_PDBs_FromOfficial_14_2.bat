...
Robocopy "R:\bin_ref\pvm\pv_static\\" %cd% "NLog.dll" "PV.Logging.pdb" /V /XO
Robocopy "R:\AutomatedVersionRepository\_latest\PVM Core_14.2\Debug\\" %cd% "App_Code.pdb"  /V /XO
