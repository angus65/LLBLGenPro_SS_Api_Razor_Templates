...
{ 
    public partial class ProductServiceRepository : EntityServiceRepositoryBase<Product, ProductEntity, ProductEntityFactory>, IProductServiceRepository
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
    {
        ...
        public DataTableResponse GetDataTableResponse(ProductDataTableRequest request)
        {
            ...
            var columnFieldIndexNames = Enum.GetNames(typeof(ProductFieldIndex));
