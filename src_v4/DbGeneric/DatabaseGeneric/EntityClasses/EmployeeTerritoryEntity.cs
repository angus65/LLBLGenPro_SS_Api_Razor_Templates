...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public EmployeeTerritoryEntity(IEntityFields2 fields):base("EmployeeTerritoryEntity")
		{
		...
		public EmployeeTerritoryEntity(IValidator validator):base("EmployeeTerritoryEntity")
		{
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoryEntityFactory));
		}
#if !CF
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Northwind.Data.RelationClasses.StaticEmployeeTerritoryRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncTerritory(IEntityCore relatedEntity)
		{
			if(_territory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _territory, new PropertyChangedEventHandler( OnTerritoryPropertyChanged ), "Territory", Northwind.Data.RelationClasses.StaticEmployeeTerritoryRelations.TerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)Northwind.Data.EntityType.EmployeeTerritoryEntity, (int)Northwind.Data.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("Territory")[0], (int)Northwind.Data.EntityType.EmployeeTerritoryEntity, (int)Northwind.Data.EntityType.TerritoryEntity, 0, null, null, null, null, "Territory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.Data.EntityType.EmployeeTerritoryEntity; }
		}
    ...
    public override List<IPrefetchPathElement2> PrefetchPaths
    {
      get
      {
        ...
        paths.Add(PrefetchPathTerritory);
