...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public RegionEntity(IEntityFields2 fields):base("RegionEntity")
		{
		...
		public RegionEntity(IValidator validator):base("RegionEntity")
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoTerritories()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(TerritoryFields.RegionId, null, ComparisonOperator.Equal, this.RegionId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(RegionEntityFactory));
		}
#if !CF
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<TerritoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(TerritoryEntityFactory))), (IEntityRelation)GetRelationsForField("Territories")[0], (int)Northwind.Data.EntityType.RegionEntity, (int)Northwind.Data.EntityType.TerritoryEntity, 0, null, null, null, null, "Territories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<TerritoryEntity, TerritoryEntityFactory>("Region", true, false, ref _territories);	}
		}
		...
		{ 
			get { return (int)Northwind.Data.EntityType.RegionEntity; }
		}
    ...
    public override List<IPrefetchPathElement2> PrefetchPaths
    {
      get
      {
        ...
        paths.Add(PrefetchPathTerritories);
