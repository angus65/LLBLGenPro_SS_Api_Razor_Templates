...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public CategoryEntity(IEntityFields2 fields):base("CategoryEntity")
		{
		...
		public CategoryEntity(IValidator validator):base("CategoryEntity")
		{
		...
		public virtual IRelationPredicateBucket GetRelationInfoProducts()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductFields.CategoryId, null, ComparisonOperator.Equal, this.CategoryId));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)Northwind.Data.EntityType.CategoryEntity, (int)Northwind.Data.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Category", true, false, ref _products);	}
		}
		...
		{ 
			get { return (int)Northwind.Data.EntityType.CategoryEntity; }
		}
