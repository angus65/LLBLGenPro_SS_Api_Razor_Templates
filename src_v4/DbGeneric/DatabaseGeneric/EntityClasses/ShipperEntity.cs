...
namespace Northwind.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)Northwind.Data.EntityType.ShipperEntity, (int)Northwind.Data.EntityType.OrderEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("Shipper", true, false, ref _orders);	}
		}
		...
		{ 
			get { return (int)Northwind.Data.EntityType.ShipperEntity; }
		}
