...
namespace Northwind.Data.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'SummaryOfSalesByQuarter'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class SummaryOfSalesByQuarterTypedView : TypedViewBase<SummaryOfSalesByQuarterRow>, ITypedView2
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SummaryOfSalesByQuarterTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public SummaryOfSalesByQuarterTypedView():base("SummaryOfSalesByQuarter")
		{
			InitClass();
		}
#if !CF	
		...
		protected SummaryOfSalesByQuarterTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new SummaryOfSalesByQuarterRow(rowBuilder);
		}
		...
		{
			TableName = "SummaryOfSalesByQuarter";		
		...
		{
			SummaryOfSalesByQuarterTypedView cloneToReturn = ((SummaryOfSalesByQuarterTypedView)(base.Clone()));
		...
		{
			return new SummaryOfSalesByQuarterTypedView();
		}
#endif
		...
		{
			get { return SummaryOfSalesByQuarterTypedView.CustomProperties;}
		}
		...
		{
			get { return SummaryOfSalesByQuarterTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable SummaryOfSalesByQuarter</summary>
	public partial class SummaryOfSalesByQuarterRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private SummaryOfSalesByQuarterTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal SummaryOfSalesByQuarterRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((SummaryOfSalesByQuarterTypedView)(this.Table));
		}

		#region Class Property Declarations

		/// <summary>Gets / sets the value of the TypedView field ShippedDate<br/><br/></summary>
		/// <remarks>Mapped on view field: "Summary of Sales by Quarter"."ShippedDate"<br/>
		...
		/// <remarks>Mapped on view field: "Summary of Sales by Quarter"."OrderID"<br/>
		...
		/// <remarks>Mapped on view field: "Summary of Sales by Quarter"."Subtotal"<br/>
