...
namespace Northwind.Data.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'OrderSubtotal'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class OrderSubtotalTypedView : TypedViewBase<OrderSubtotalRow>, ITypedView2
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static OrderSubtotalTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public OrderSubtotalTypedView():base("OrderSubtotal")
		{
			InitClass();
		}
#if !CF	
		...
		protected OrderSubtotalTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new OrderSubtotalRow(rowBuilder);
		}
		...
		{
			OrderSubtotalTypedView cloneToReturn = ((OrderSubtotalTypedView)(base.Clone()));
		...
		{
			return new OrderSubtotalTypedView();
		}
#endif
		...
		{
			get { return OrderSubtotalTypedView.CustomProperties;}
		}
		...
		{
			get { return OrderSubtotalTypedView.FieldsCustomProperties;}
		}
    ...
    {
        get { return TypedViewType.OrderSubtotalTypedView; }
    } 
		#endregion
	}

	/// <summary>Typed datarow for the typed datatable OrderSubtotal</summary>
	public partial class OrderSubtotalRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private OrderSubtotalTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal OrderSubtotalRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((OrderSubtotalTypedView)(this.Table));
		}

		#region Class Property Declarations

		/// <summary>Gets / sets the value of the TypedView field OrderId<br/><br/></summary>
		/// <remarks>Mapped on view field: "Order Subtotals"."OrderID"<br/>
		...
		/// <remarks>Mapped on view field: "Order Subtotals"."Subtotal"<br/>
