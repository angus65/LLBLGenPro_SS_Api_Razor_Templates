...
namespace Northwind.Data.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'ProductsAboveAveragePrice'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ProductsAboveAveragePriceTypedView : TypedViewBase<ProductsAboveAveragePriceRow>, ITypedView2
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ProductsAboveAveragePriceTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ProductsAboveAveragePriceTypedView():base("ProductsAboveAveragePrice")
		{
			InitClass();
		}
#if !CF	
		...
		protected ProductsAboveAveragePriceTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new ProductsAboveAveragePriceRow(rowBuilder);
		}
		...
		{
			ProductsAboveAveragePriceTypedView cloneToReturn = ((ProductsAboveAveragePriceTypedView)(base.Clone()));
		...
		{
			return new ProductsAboveAveragePriceTypedView();
		}
#endif
		...
		{
			get { return ProductsAboveAveragePriceTypedView.CustomProperties;}
		}
		...
		{
			get { return ProductsAboveAveragePriceTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable ProductsAboveAveragePrice</summary>
	public partial class ProductsAboveAveragePriceRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private ProductsAboveAveragePriceTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ProductsAboveAveragePriceRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ProductsAboveAveragePriceTypedView)(this.Table));
		}

		#region Class Property Declarations

		/// <summary>Gets / sets the value of the TypedView field ProductName<br/><br/></summary>
		/// <remarks>Mapped on view field: "Products Above Average Price"."ProductName"<br/>
		...
		/// <remarks>Mapped on view field: "Products Above Average Price"."UnitPrice"<br/>
