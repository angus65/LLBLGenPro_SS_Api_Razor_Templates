...
namespace Northwind.Data.ValidatorClasses
{
	...
	/// <summary>Implementation of the Category Validator class. This class is the default location for validation rules for the
	/// CategoryEntity class. 	/// This class is generated. A special user code region is available for you to add your own validation logic by overriding the base class methods. This code is preserved between code generation cycles.
	/// Though it's recommended that you use a partial class.</summary>
	[Serializable]
	public partial class CategoryValidator : ValidatorBase
	{
