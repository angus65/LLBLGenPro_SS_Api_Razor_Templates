...
namespace Northwind.Data.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitEmployeeEntityMappings()
		{
			...
			this.AddElementFieldMapping("EmployeeEntity", "EmployeeId", "EmployeeID", false, "Int", 0, 10, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int32), 0);
			...
			this.AddElementFieldMapping("EmployeeEntity", "ReportsToId", "ReportsTo", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 16);
		...
		private void InitOrderEntityMappings()
		{
			...
			this.AddElementFieldMapping("OrderEntity", "EmployeeId", "EmployeeID", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			...
			this.AddElementFieldMapping("OrderEntity", "ShipVia", "ShipVia", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 6);
			this.AddElementFieldMapping("OrderEntity", "Freight", "Freight", true, "Money", 0, 19, 4, false, "", null, typeof(System.Decimal), 7);
		...
		private void InitOrderDetailEntityMappings()
		{
			...
			this.AddElementFieldMapping("OrderDetailEntity", "OrderId", "OrderID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 0);
			this.AddElementFieldMapping("OrderDetailEntity", "ProductId", "ProductID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 1);
			this.AddElementFieldMapping("OrderDetailEntity", "UnitPrice", "UnitPrice", false, "Money", 0, 19, 4, false, "", null, typeof(System.Decimal), 2);
			this.AddElementFieldMapping("OrderDetailEntity", "Quantity", "Quantity", false, "SmallInt", 0, 5, 0, false, "", null, typeof(System.Int16), 3);
			this.AddElementFieldMapping("OrderDetailEntity", "Discount", "Discount", false, "Real", 0, 24, 0, false, "", null, typeof(System.Single), 4);
		}
		...
		private void InitProductEntityMappings()
		{
			...
			this.AddElementFieldMapping("ProductEntity", "SupplierId", "SupplierID", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("ProductEntity", "CategoryId", "CategoryID", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 3);
			...
			this.AddElementFieldMapping("ProductEntity", "UnitPrice", "UnitPrice", true, "Money", 0, 19, 4, false, "", null, typeof(System.Decimal), 5);
			this.AddElementFieldMapping("ProductEntity", "UnitsInStock", "UnitsInStock", true, "SmallInt", 0, 5, 0, false, "", null, typeof(System.Int16), 6);
			this.AddElementFieldMapping("ProductEntity", "UnitsOnOrder", "UnitsOnOrder", true, "SmallInt", 0, 5, 0, false, "", null, typeof(System.Int16), 7);
			this.AddElementFieldMapping("ProductEntity", "ReorderLevel", "ReorderLevel", true, "SmallInt", 0, 5, 0, false, "", null, typeof(System.Int16), 8);
		...
		private void InitRegionEntityMappings()
		{
			...
			this.AddElementFieldMapping("RegionEntity", "RegionId", "RegionID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 0);
		...
		private void InitShipperEntityMappings()
		{
			...
			this.AddElementFieldMapping("ShipperEntity", "ShipperId", "ShipperID", false, "Int", 0, 10, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int32), 0);
		...
		{
			this.AddElementMapping("TerritoryEntity", @"Northwind", @"dbo", "Territories", 3, 0);
			...
			this.AddElementFieldMapping("TerritoryEntity", "RegionId", "RegionID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
		}


		/// <summary>Inits AlphabeticalListOfProductsView's mappings</summary>
		private void InitAlphabeticalListOfProductsTypedViewMappings()
		{
			...
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "ProductId", "ProductID", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 0);
			...
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "SupplierId", "SupplierID", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "CategoryId", "CategoryID", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 3);
			...
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "UnitPrice", "UnitPrice", false, "Money", 0, 19, 4, false, string.Empty, null, typeof(System.Decimal), 5);
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "UnitsInStock", "UnitsInStock", false, "SmallInt", 0, 5, 0, false, string.Empty, null, typeof(System.Int16), 6);
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "UnitsOnOrder", "UnitsOnOrder", false, "SmallInt", 0, 5, 0, false, string.Empty, null, typeof(System.Int16), 7);
			this.AddElementFieldMapping("AlphabeticalListOfProductsTypedView", "ReorderLevel", "ReorderLevel", false, "SmallInt", 0, 5, 0, false, string.Empty, null, typeof(System.Int16), 8);
